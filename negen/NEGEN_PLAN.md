...
## 1. Vision
NEGEN is a homegrown, modular game engine designed to power the F.O.N.G.. It abstracts common game development tasks (rendering, input, audio, state management) into a unified API, facilitating rapid development of future games (e.g., Poker) and eventual retrofitting of existing titles.
