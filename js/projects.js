var projects = [
    ...
    { name: "J: Speed Quiz (Legacy)", path: "games/j_v1/index.html", category: "arcade", icon: "⚡", tags: ["Legacy"], description: "Legacy version of the speed quiz engine." },    { name: "Flash Classics", path: "games/flash_classics/index.html", category: "arcade", icon: "🕹️", tags: ["Retro"], description: "Collection of classic Flash-style games: Chopper, Defender, Runner." },
