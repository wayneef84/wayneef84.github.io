...
|---------|------|----------------|--------|--------------|-------|
| `games/cards/war` | Game | v1.0.1 | ✅ Up-to-date | 2026-01-17 | Battle history complete |
...
### 2026-01-17: War Upgraded to Shared v1.0.1
- War upgraded to Shared v1.0.1 (tested and working)
- Blackjack remains on v1.0.0 (upgrade available)
- Federated architecture upgrade workflow validated
